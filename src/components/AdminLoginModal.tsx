  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fade-in">
      <div
        ...
        tabIndex={-1}
        className="relative w-full max-w-md bg-[#0d0d0c] border border-cyan-500/30 rounded-2xl shadow-2xl p-6 md:p-8 text-slate-100 overflow-hidden animate-dialog-in"
      >
